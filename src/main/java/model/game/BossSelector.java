...
/** Policy for choosing an ante's boss blind, injected via {@link MatchConfig} like {@link SinSelector}: the default draws from the table-level stream, while tests and scripted matches can pin a specific boss. */
@FunctionalInterface
