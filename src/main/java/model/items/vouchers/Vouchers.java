...
public enum Vouchers {
    ...
    HONE("Hone", null, "Shop jokers gain shiny editions more often.", r -> r.shopMods().setEditionRate(1)),
    GLOW_UP("Glow Up", HONE, "Shop jokers gain shiny editions much more often.", r -> r.shopMods().setEditionRate(2)),
    ...
    OMEN_GLOBE("Omen Globe", CRYSTAL_BALL, "Spectral cards may appear in Arcana Packs.", r -> r.shopMods().setOmenGlobe(true)),

    TELESCOPE("Telescope", null, "Celestial Packs contain your most-played hand's Planet.", r -> r.shopMods().setTelescope(true)),
    OBSERVATORY("Observatory", TELESCOPE, "Planets you hold apply their hand's Mult when scoring.", r -> { r.shopMods().setTelescope(true); r.shopMods().setObservatory(true); }),
    ...
    TAROT_MERCHANT("Tarot Merchant", null, "Tarot cards appear more often in the shop.", r -> r.shopMods().addTarotWeight(20)),
    TAROT_TYCOON("Tarot Tycoon", TAROT_MERCHANT, "Tarot cards appear much more often in the shop.", r -> r.shopMods().addTarotWeight(40)),

    PLANET_MERCHANT("Planet Merchant", null, "Planet cards appear more often in the shop.", r -> r.shopMods().addPlanetWeight(20)),
    PLANET_TYCOON("Planet Tycoon", PLANET_MERCHANT, "Planet cards appear much more often in the shop.", r -> r.shopMods().addPlanetWeight(40)),
    ...
    MAGIC_TRICK("Magic Trick", null, "Playing cards can be purchased from the shop too.", r -> r.shopMods().setMagicTrickCards(true)),
    ILLUSION("Illusion", MAGIC_TRICK, "Playing cards are more likely to have enhancements, editions and seals.", r -> { r.shopMods().setMagicTrickCards(true); r.shopMods().setIllusion(true); }),
    ...
    RELIC_MERCHANT("Relic Merchant", null, "Relics appear more often in the shop.", r -> r.shopMods().addRelicWeight(20)),
    RELIC_TYCOON("Relic Tycoon", RELIC_MERCHANT, "Relics appear much more often in the shop.", r -> r.shopMods().addRelicWeight(40)),

    SHOWMAN("Showman", null, "Jokers and consumables you already own can still appear in the shop.", r -> r.shopMods().setShowman(true)),
    ENCORE("Encore", null, "Jokers and consumables you already own appear more often.", r -> r.shopMods().setEncore(true));
